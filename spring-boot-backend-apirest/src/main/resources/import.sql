...
INSERT INTO `usuarios` (username,password, enabled, nombre, apellido, email) VALUES("andres",'$2a$10$gUQ6j/./kwkWD6IwnQZ8Ae1zjPt59yCz5jeozyyPR3qEzs9zg675m',1,'Andres','Guzman','profesor@gmail.com');
INSERT INTO `usuarios` (username,password, enabled, nombre, apellido, email) VALUES("admin",'$2a$10$7KWok9CoVuyw5I1kxNbyeuH41i3FMKXtzJe7H5sTx9PsHC1gdwoAq',1,'John','Doe','admin@gmail.com');
